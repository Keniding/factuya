...
| `@aws-sdk/client-kms` | 3.1100.0 | 2026-07-31 — instalado de verdad con `bun add` en entorno aislado, tipos leídos contra el paquete real. **Verificado en vivo el 2026-08-02** contra una cuenta de AWS de prueba (`Sign`, `CreateGrant`, `RetireGrant`, `ScheduleKeyDeletion` — ver `docs/aws/kms-live-verification.md`) | Sí — org oficial `aws/aws-sdk-js-v3` en GitHub, mantenedores `amzn-oss`/`aws-sdk-bot` | [`deps-aws-sdk-client-kms`](../../.claude/skills/deps-aws-sdk-client-kms.md) | Sin fecha fija — revisar si cambia el nombre del `SigningAlgorithm` o el modelo de Grants en un major futuro |
